...
import ProductoService from '../../services/ProductoService';
 // Ajustá la ruta según la ubicación real
...
const CrearPedidoModal = ({ open, handleClose, refreshPedidos }) => {
  ...
  const agregarProducto = () => {
    setPedido({ ...pedido, detalles: [...pedido.detalles, { producto_id: '', cantidad: 1 }] });
  };
  ...
  return (
    <Dialog open={open} onClose={handleClose} maxWidth="md" fullWidth>
      <DialogTitle sx={{ backgroundColor: '#438892', color: 'white' }}>Nuevo Pedido</DialogTitle>
      <DialogContent dividers>
        <Box>
          <TextField
            ...
            onChange={(e) => setPedido({ ...pedido, direccion_envio: e.target.value })}
          />
